...
<#
regular alpha base on ASCII : [char[]](65..90 + 97..122)
random get 6 element from arrary : Get-Random -Count 6)
#>
...
function Invoke-MD5 {
<#
check hash to define duplicate
#>
    param (
        # Parameter Path
        [Parameter(Mandatory)]
